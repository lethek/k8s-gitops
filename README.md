...
If Terraform was ran successfully and you have port forwarded `80` and `443` in your router to the `${LB_NGINX_ADDR}` IP, head over to your browser and you _should_ be able to access `https://hajimari.${BOOTSTRAP_CLOUDFLARE_DOMAIN}`!
